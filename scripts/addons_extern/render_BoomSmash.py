...
class VIEW3D_PT_tools_animation_boomsmash(Panel):
...
class VIEW3D_PT_tools_pose_animation_boomsmash(Panel):
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'TOOLS'
    bl_category = 'Tools'
    bl_context = 'posemode'
