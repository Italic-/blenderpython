...
class BUTTON_OCT_export_geometry(bpy.types.Operator):
    bl_idname = "ops.button_export_geometry"
...
class BUTTON_OCT_export_image(bpy.types.Operator):
    bl_idname = "ops.button_export_image"
...
class BUTTON_OCT_export_animation(bpy.types.Operator):
    bl_idname = "ops.button_export_animation"
...
class PROPERTIES_octane_fixmaterial(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if bpy.context.scene.octane_render.ignore_intensity:
            if mat.diffuse_intensity < 1.0:
                mat.diffuse_intensity = 1.0
            if mat.specular_intensity < 1.0:
